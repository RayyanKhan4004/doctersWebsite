...
function SearchBar() {
  ...
  return (
    <div className='font-DMSans'  >
      <h2 className='text-[28px] text-[#333333] text-center font-bold  mt-[112px]  mb-0 SearchBar '>Subscribe our newslatter</h2>
      
      <div className="flex flex-1 items-center justify-center p-6 pt-0 ">
    <div className=" max-w-lg">
        <form className="mt-5 sm:flex sm:items-center">
            <input style={{paddingLeft:24}}  id="q" name="q" 
            className="inline md:w-[420px] md:h-[55px] rounded-3xl border  border-gray-300  bg-white py-2 pl-3 pr-3
            ...
            <button type="submit" 
            className="mt-3 md:h-[55px] md:w-[116px] inline-flex w-full items-center justify-center rounded-3xl border border-transparent bg-[#007E85] 
