...
let stylesForInvert = `flex  ${invert ? 'flex-row max-lg:flex-col ' : 'flex-row-reverse max-lg:flex-col-reverse'} lg:w-[990px] gap-8 flex-row  justify-between xl:min-w-[1140px] xl:max-w-[1150px]`
    return (
    <div>
         <div className="flex justify-center items-center font-latoN  md:w-[100%] mt-14 ">
      <div
        className={stylesForInvert}      
      >
          ...
          className="">
           ...
           {heading}
            ...
            <div style={{ marginTop: "30px" }} className="w-[587] text-sm">
              <p className=" max-md:w-auto md:w-[500px] "
                style={{
                  fontFamily: "Lato",
                  fontSize: "18px",
                  color: "#474747",
        ...
        className="flex justify-center items-center lg:min-h-[330px]">
          <img className="mb-6 max-md:w-auto md:w-[570px] max-md:mx-6" src={img} alt="img" />
        </div>
      </div>
    </div>
    </div>
